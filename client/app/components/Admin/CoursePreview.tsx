  ...
  return (
    <div className=" w-[90%] m-auto py-5 mb-0">
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          <div
            className={`${styles.btnVideo} !w-[230px] !bg-[crimson] !cursor-not-allowed`}
          >
        ...
        <div className="flex items-center gap-3 w-full">
          <input
            ...
            className={`${styles.inputs} !w-[70%] !mt-0`}
          />
          <div className={`${styles.btnVideo} !w-[20%]`}>Apply</div>
        </div>
      ...
      <div className=" w-full flex items-center justify-between pr-[100px] ">
        <div
          className={`${styles.btnVideo} !w-[200px]`}
          onClick={() => prevButton()}
        >
          Prev
        </div>
