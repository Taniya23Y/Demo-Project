...
const CourseContentMedia = ({
  ...
  const [
    addNewQuestion,
    { isSuccess: questionSuccess, error, isLoading: questionLoading },
  ] = useAddNewQuestionMutation();
  const [
    addAnswer,
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <br />
      {activeBar === 0 && (
        <p className=" text-[18px] text-white whitespace-pre-line mb-3">
              ...
              <>
                ...
                <div className="w-full flex justify-end">
                  <div
                    className={`${
                      styles.btnVideo
                    } !w-[120px] !h-[40px] flex items-center justify-center text-center mt-5 800px:mr-0 mr-2 ${
                    ...
                    {isReviewReply && reviewId === item._id && (
                      <div className=" w-full flex relative">
                        <input
                          ...
                          className={`${styles.btnVideo} !bg-transparent !border-b border-[0px] ml-[3%] !rounded-none w-[90%]`}
                        />
                        <button
                          type="submit"
